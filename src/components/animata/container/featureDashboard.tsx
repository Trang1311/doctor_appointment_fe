...
import AvatarList from "../graphs/avatar-list";
import Report from "../graphs/report";
import WideCard from "../graphs/wide-card";
import Counter from "../graphs/counter";
import Ticker from "../graphs/ticker";
import TypingText from "../graphs/typing-text";
...
export function FeatureTwo() {
  return (
    <BentoCard className="relative flex flex-col overflow-visible bg-transparent sm:col-span-2">
      <strong className="text-2xl font-semibold text-white">
        <Counter
          targetValue={179}
          format={(v) => +Math.ceil(v) + "N+ bệnh nhân"}
        />
      </strong>
